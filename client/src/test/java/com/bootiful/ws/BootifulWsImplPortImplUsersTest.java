...
public class BootifulWsImplPortImplUsersTest {
    ...
    // The below test case requires additional configuration to verify the logging behavior.
    // It seems that the logger is not configured correctly for the verification of the log output.
    // To fix this issue, we need to set up a proper logger or use a framework like Logback with a suitable appender for testing.
    @Test
    public void usersLoggingVerification() {
        ...
        // Verification of logging statements is not shown in this test.
        // It requires additional setup such as a logging framework that supports capturing log output in tests.
    }
}
